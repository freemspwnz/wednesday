...
def _create_retry_decorator(  # noqa: PLR0913, PLR0917
    ...
    def before_sleep_callback(retry_state: RetryCallState) -> None:
        ...
        # Обновляем метрики
        try:
            from infra.metrics.prometheus_metrics import HTTP_RETRIES_TOTAL, HTTP_RETRY_WAIT_SECONDS
    ...
    def after_callback(retry_state: RetryCallState) -> None:
        ...
        if retry_state.outcome and retry_state.outcome.failed:
            ...
            # Обновляем метрики
            try:
                from infra.metrics.prometheus_metrics import HTTP_RETRIES_TOTAL
