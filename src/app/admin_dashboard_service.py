        ...
        *,
        ...
        Args:
            usage: Трекер использования (опционально).
                Если None, в статусе отображается "N/A" для информации об использовании.
                Не критично для основной функциональности дашборда.
            chats: Репозиторий чатов (опционально).
                Если None, в статусе отображается "N/A" для количества активных чатов.
                Не критично для основной функциональности дашборда.
            ...
            models_list_builder: Билдер сообщений списка моделей (опционально).
                Если None, создается новый экземпляр ModelsListMessageBuilder.
