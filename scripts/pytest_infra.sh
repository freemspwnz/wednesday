...
# Pytest для infra-набора внутри контейнера tests.
MARK_EXPR="${MARK_EXPR:-e2e and infra}"
COVERAGE_FILE="${COVERAGE_FILE:-.coverage.infra}"
JUNIT_FILE="${JUNIT_FILE:-junit-infra.xml}"
...
echo "✓ Infra тесты завершены: ${COVERAGE_FILE}"
