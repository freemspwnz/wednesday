...
from .factories import dt, plan_free
...
def test_repo_protocol_shapes() -> None:
    ...
    assert hasattr(ModelCatalog, "get_by_model")
    assert hasattr(ModelCatalog, "list_active")
    assert hasattr(ModelCatalog, "default_for_tier")
    assert hasattr(UsageRepo, "get_stats")
    assert hasattr(UsageRepo, "record")
    assert hasattr(ViolationRepo, "get_violation_stats")
    assert hasattr(ViolationRepo, "record_violation")
    assert hasattr(SubscriptionCatalog, "default_plan")
