...
2. [Шаг 1: Клонирование и Конфигурация](#step-1-clone-and-config)
3. [Шаг 2: Сборка и Запуск](#step-2-build-and-run)
4. [Шаг 3: Миграция Базы Данных (Первый Запуск)](#step-3-db-migration-first-run)
5. [Шаг 4: Тестирование](#step-4-testing)
...
## Шаг 1: Клонирование и Конфигурация {#step-1-clone-and-config}
...
## Шаг 2: Сборка и Запуск {#step-2-build-and-run}
...
## Шаг 3: Миграция Базы Данных (Первый Запуск) {#step-3-db-migration-first-run}
...
## Шаг 4: Тестирование {#step-4-testing}
