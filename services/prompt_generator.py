...
class PromptStorage:
    ...
    def __init__(self, base_dir: Path | None = None) -> None:
        """Инициализирует файловое хранилище промптов.
    ...
    def save_prompt(self, prompt: str, source: str = "gigachat") -> str | None:
        ...
        Raises:
            ...
            OSError: При ошибке записи файла (недостаточно прав, места на диске и т.д.).
    ...
    def get_random_prompt(self) -> str | None:
        ...
        Выбирает случайный TXT файл из директории промптов и возвращает его содержимое.
        Используется другими сервисами как файловый fallback при сбоях GigaChat.

        Returns:
            Случайный промпт из файла или None, если:
            - директория не существует.
            - в директории нет TXT файлов.
            - файл пуст или произошла ошибка при чтении.
