...
**Wednesday Bot** — полнофункциональный Telegram-бот для автоматической генерации и отправки изображений жабы с мемами про среду. Бот использует нейросеть Kandinsky для генерации разнообразных изображений и автоматически отправляет их в указанные чаты каждую среду в заданное время.
