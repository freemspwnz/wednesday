...
PATHS := wednesday/domain/ wednesday/app/ wednesday/infra/observe/ wednesday/infra/config/observe/ tests/
TESTS := tests/
COV := --cov=domain --cov=app --cov=infra.observe --cov=infra.config.observe
